...
class Testing(unittest.TestCase):
    ...
    def testCompressionRatio0(self):
        self.assertEqual(self.speechSet.wordUsage.__len__(),self.file0Frequency.__len__())
        self.assertEqual(self.speechSet.wordUsage.__len__(),self.file1Frequency.__len__())
    ...
    def testCompressionRatio1(self):
        ...
        speech0 = speech.Speech(self.file0.name,self.speechSet.wordUsage)
        speech1 = speech.Speech(self.file1.name,self.speechSet.wordUsage)
        self.assertEqual(speech0.wordUsage,self.file0Frequency)
        self.assertEqual(speech1.wordUsage,self.file1Frequency)
